...
- Les couleurs sont affichées en nuage de points à l'intérieur d'un cube. La coordonnées 3D d'un point correspond a la nuance (sur 256) de chaque composante RVB d'une couleur.
